...
import numpy as np
import torch
from baselines.CausE import CausE_rate
...
if __name__ == '__main__':
    ...
    parser.add_argument('--emb_l2rg', type=float, default=1e-5)
    ...
    parser.add_argument('--cf_distance', default='l2')
    parser.add_argument('--w_cf', type=float, default=1.0)
    ...
    for r in range(1, args.repeat + 1):
        ...
        model = CausE_rate(user_num, item_num, args).to(device)
