...
import numpy as np
import torch
from models.CIDR import CIDR_rate
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default='CIDR')
    parser.add_argument("--edim", type=int, default=8)
    ...
    for r in range(1, args.repeat + 1):
        ...
        model = CIDR_rate(user_num, item_num, args).to(device)
